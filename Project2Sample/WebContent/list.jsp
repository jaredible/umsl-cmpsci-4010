...
<%@ page import="edu.umsl.java.model.*"%>
								...
								<tr>
									...
									<td width="10%">
										<div class="input-group-btn">
											<c:if test="${crtpg > 1}">
												<button id="upleftpagebtn" type="button" style="height: 2.4em"
													onclick="loadProblemsAtPage(0)" class="btn btn-default">
													<span class="glyphicon glyphicon-triangle-left"
														aria-label="Left"></span>
												</button>
											</c:if>
											<c:if test="${crtpg < maxpg}">
												<button id='uprightpagebtn' type="button" style="height: 2.4em"
													onclick="loadProblemsAtPage(1)" class="btn btn-default">
