...
<c:set var="pageTitle" value="New Tag" scope="request" />
				...
				<div class="ui container" style="margin-top: 3vh; margin-bottom: 3vh;">
					<div class="ui center aligned grid" style="height: 100%;">
						<div class="column" style="max-width: 450px;">
							<h2>Add a new tag</h2>
							<form class="ui large form" action="<c:url value='/tag/new' />" method="post">
								<div class="ui segment">
									...
									<button class="ui large primary fluid button" type="submit">Add tag</button>
								</div>
							</form>
						</div>
					</div>
