...
<c:set var="pageTitle" value="Security" scope="request" />
								...
								<div class="wide column">
									...
									<form class="ui form raised stacked bottom attached segment" action="profile" method="post">
										<div class="ui field">
											...
											<div class="ui container">
												<img id="profilePicture" class="ui small rounded image" src="https://fomantic-ui.com/images/avatar/small/matt.jpg">
