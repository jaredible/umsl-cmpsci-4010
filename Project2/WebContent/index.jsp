								...
								<div class="d-flex w-100 justify-content-between align-items-center">
									...
									<div>
										<small class="mb-1">3 days ago</small>
											<button type="button" class="btn btn-sm btn-outline-info waves-effect">Edit</button>
											<button type="button" class="btn btn-sm btn-outline-red waves-effect">Delete</button>
									</div>
								</div>
