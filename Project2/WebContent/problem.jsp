		...
		<div class="wrapper">
			...
			<div class="main">
				<div class="container">
					...
					<form class="problem-form needs-validation" action="problem?id=${param.id}" method="post" novalidate>
						...
						<div class="form-row justify-content-center align-items-center">
							<div class="col-xs-12 col-sm-8">
								<textarea class="form-control w-100 h-100" name="content">${content}</textarea>
							</div>
						</div>
						<div class="d-flex justify-content-center align-items-center">
							<button class="btn btn-outline-grey waves-effect" type="submit">Post</button>
						</div>
					</form>
					<% } else { %>
