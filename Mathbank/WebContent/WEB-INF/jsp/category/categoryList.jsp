...
<html>
	<head>
		...
		<title>Categories | Mathbank</title>
	...
	<body>
		<div class="wrapper">
			<a class=position-absolute href="https://github.com/jaredible/umsl-cmpsci-4010/tree/master/Mathbank" target="_blank"><img width="149" height="149" src="https://github.blog/wp-content/uploads/2008/12/forkme_left_white_ffffff.png?resize=149%2C149" class="attachment-full size-full" alt="Fork me on GitHub" data-recalc-dims="1"></a>
			...
			<div class="main">
				...
				<div class="container">					
					...
					<div class="d-flex justify-content-center align-items-center mt-3">
						<a class="btn btn-lg btn-primary" href="newCategory">Add category</a>
					</div>
				</div>
				<!-- END MAIN CONTENT -->
			</div>
