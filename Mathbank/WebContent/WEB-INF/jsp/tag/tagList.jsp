			...
			<div class="main">
				...
				<header>
					<ul id="pills-tab" class="nav nav-pills justify-content-center my-3" role="tablist">
						...
						<li class="nav-item">
							<a id="pills-tags-tab" class="nav-link active" href="tag">Tags</a>
						</li>
					</ul>
				</header>
				<!-- END TABS -->
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								<c:forEach var="tag" items="${tags}">
									<tr>
										<th scope="row" width="5%"><a href="tag?id=${tag.id}">${tag.id}</a></th>
										<td width="90%"><c:out value="${tag.name}" /></td>
										<td width="5%"><c:out value="${fn:toUpperCase(tag.edited)}" /></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
